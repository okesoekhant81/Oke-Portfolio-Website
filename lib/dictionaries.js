...
export const dictionaries = {
  en: {
    ...
    workshop: {
      ...
      cohortCompletedLabel: 'Latest cohort completed',
      cohortCompletedBody: 'students recently finished this workshop',
  ...
  my: {
    ...
    workshop: {
      ...
      cohortCompletedLabel: 'နောက်ဆုံးသင်တန်း ပြီးဆုံးပါပြီ',
      cohortCompletedBody: 'ဦး ဒီ workshop ကို လတ်တလော ပြီးဆုံးအောင် သင်ယူခဲ့ကြပါသည်',
