...
export const dictionaries = {
  en: {
    ...
    workshop: {
      ...
      formPaymentHeading: 'Payment (optional)',
      ...
      formPaymentSkipHint: "You can also pay later — we'll follow up either way.",
    },
    cookieConsent: {
  ...
  my: {
    ...
    workshop: {
      ...
      formPaymentHeading: 'ငွေပေးချေမှု (ရွေးချယ်ခွင့်)',
      ...
      formPaymentSkipHint: 'နောက်မှလည်း ငွေပေးချေနိုင်ပါတယ် — ဘယ်လိုပဲဖြစ်ဖြစ် ဆက်သွယ်ပါမယ်။',
    },
    cookieConsent: {
