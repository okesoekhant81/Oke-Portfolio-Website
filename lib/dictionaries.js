...
export const dictionaries = {
  en: {
    ...
    cookieConsent: {
      message: 'This site uses only essential cookies — to keep the admin panel signed in and remember your language preference. No tracking or advertising cookies.',
      accept: 'Got it',
  ...
  my: {
    ...
    cookieConsent: {
      message: 'ဒီဆိုက်မှာ လိုအပ်တဲ့ cookie လေးတွေကိုသာ သုံးပါတယ် — admin panel ဝင်ထားတာ မပြတ်အောင်နဲ့ ဘာသာစကား ရွေးချယ်မှုကို မှတ်ထားဖို့ပါ။ Tracking သို့မဟုတ် ကြော်ငြာ cookie လုံးဝ မသုံးပါ။',
      accept: 'နားလည်ပါပြီ',
