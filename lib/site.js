...
// Same reasoning as GA_MEASUREMENT_ID above — a Pixel/dataset id is public
// the moment the script loads, so it's a plain constant, not an env var.
// The CAPI access token that pairs with it is the actual secret and lives
// in META_CAPI_ACCESS_TOKEN (server-only, see lib/metaCapi.js) instead.
export const META_PIXEL_ID = '28372066225746859'
