...
function resolveDefaults() {
  return {
    ...
    // Optional — the registration form only shows a payment step once a QR
    // image has actually been uploaded, so an empty default here just
    // means "no online payment option yet" rather than a broken image.
    paymentQrImage: '',
    paymentInstructions: '',
    paymentInstructionsMy: '',
  }
}
